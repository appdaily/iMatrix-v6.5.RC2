		...
		$("#jobInfoFrom").validate({
			submitHandler: function() {
				...
				if(typeof(rtxAccounts)!='undefined'&&rtxAccounts.length>1000){
					...
					alert(iMatrixMessage["bs.jobInfo.fieldRtxReminder"]+rtxAccounts.length);
					return;
				}
				...
				if(typeof(phoneReminderNums)!='undefined'&&phoneReminderNums.length>1000){
					...
					alert(iMatrixMessage["bs.jobInfo.fieldMessageReminder"]+phoneReminderNums.length);
					return;
				}
				...
				if(typeof(officeHelperReminderNames)!='undefined'&&officeHelperReminderNames.length>490){
					...
					alert(iMatrixMessage["bs.jobInfo.fieldOfficerReminder"]+officeHelperReminderNames.length);
					return;
				}
