			...
			$.ajax({
				...
				success:function(data, textStatus){
					if("ok"==data){
						...
						alert(iMatrixMessage["authorization.noAuthAddRole"]);//无权限为此分支机构添加角色！
					}
				},
			...
			$.ajax({
				...
				success:function(data, textStatus){
					if("ok"==data){
						...
						alert(iMatrixMessage["authorization.noAuthAddManager"]);//无权限为此分支机构添加管理员！
					}
				},
				complete:function(XMLHttpRequest, textStatus){},
		        error:function(){
				...
				success:function(data, textStatus){
					if("ok"==data){
						...
						if(userIdsLength==0&&roleIdsLength==0){
							alert(iMatrixMessage["authorization.selectDelete"]);//请选择移除项！
						}else{
							if(confirm(iMatrixMessage["authorization.sureDeleteSeledted"])){//确定要移除所选项?
								$.ajax({
						...
						alert(iMatrixMessage["authorization.noAuthRemoveUserAndRole"]);//无权限移除此分支机构下的人员和角色！
					}
				},
				complete:function(XMLHttpRequest, textStatus){},
		        error:function(){
