	...
	<script type="text/javascript">
			...
			$("#inputForm").validate({
				submitHandler: function() {
					if(($("#startRow").val()!=''&&!validateImportRow($("#startRow").val()))||($("#endRow").val()!=''&&!validateImportRow($("#endRow").val()))){
						alert(iMatrixMessage["basicSetting.importRowInsertValidate"]);
						return;
					}
		...
		function importData(url){
			...
			if(ids==""){
				...
				$.colorbox({href:url+"?importDefinitionId="+ids[0],iframe:true, innerWidth:300, innerHeight:100,overlayClose:false,title:iMatrixMessage["basicSetting.importColorboxTitle"]});
			}
