...
<head>
	...
	<script type="text/javascript">
		...
		function exportDataTable(){
			...
			if(ids==''){
				if(confirm(iMatrixMessage["formManager.exportTableInfo"])){
		...
		function importDataTable(){
			$.colorbox({href:'${mmsCtx}/form/show-import-data-table.htm',
				iframe:true, innerWidth:350, innerHeight:100,overlayClose:false,title:iMatrixMessage["formManager.importDateSheet"]});
		}
		...
		function deleteEnableTableInfo(){
			...
			if(ids==''){
				...
				if(confirm(iMatrixMessage["formManager.delelteAssociateAll"])){
					$.each(ids, function(i){
