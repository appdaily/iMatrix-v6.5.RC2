...
<head>
	...
	<script type="text/javascript">
		...
		function exportListView(){
			...
			if(ids==''){
				if(confirm(iMatrixMessage["formManager.exportInfo"])){
		...
		function importListView(){
			$.colorbox({href:'${mmsCtx}/form/show-import-list-view.htm',
				iframe:true, innerWidth:350, innerHeight:100,overlayClose:false,title:iMatrixMessage["formManager.importListValidate"]});
		}
