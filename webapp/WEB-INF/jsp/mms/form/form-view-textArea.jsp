					...
					<tbody>
							...
							<tr>
								...
								<td>
									<s:if test="tableColumnId==null||tableColumnId==0">
										<s:textfield theme="simple" id="name" name="formControl.name" cssClass="{required:true,messages: {required:'required'}}"></s:textfield>
									</s:if>
									<s:else>
										<s:textfield theme="simple" id="name" name="formControl.name" readonly="true" cssClass="{required:true,messages: {required:'required'}}"></s:textfield>
									</s:else>
						...
						<s:else>
							<tr>
								...
								<td>
									<s:textfield theme="simple" id="name" name="formControl.name"  cssClass="{required:true,messages: {required:'required'}}" onblur="fieldNameOk(this);" maxlength="27"></s:textfield>
									<span class="required">*</span>
								</td>
								<td>
									<span id="nameTip"></span>
						...
						<tr>
							...
							<td>
								<s:textfield theme="simple" id="title" name="formControl.title"  cssClass="{required:true,messages: {required:'required'}}"></s:textfield>
								<span class="required">*</span>
