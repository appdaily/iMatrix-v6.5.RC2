						...
						<table class="form-table-without-border">
							...
							<s:if test="standard">
								...
								<tr>
									...
									<td>
										<s:textfield theme="simple" id="name" maxlength="27" name="formControl.name"  cssClass="{required:true,messages: {required:'required'}}" onblur="fieldNameOk(this);"></s:textfield>
										<span class="required">*</span>
									</td>
									<td>
										<span id="nameTip"></span>
