		      ...
		      onSelect: function(dateText, inst){
				...
				if(endStr!=""&&typeof(endStr)!="undefined"){
				      ...
				      if(beginDate.getTime()>=endDate.getTime()){
				    	  alert(iMatrixMessage["wf.theEffectiveDate"]);
			    ...
			    if(beginDate.getTime()<currentDate.getTime()){
					alert(iMatrixMessage["wf.effectiveDateShould"]);
					$('#beginTime').attr("value","");
				}
		      ...
		      onSelect: function(dateText, inst){
				var endDate=formatStrToDate(dateText);
			     ...
			     if(beginStr!=""&&typeof(beginStr)!="undefined"){
				      ...
				      if(beginDate.getTime()>=endDate.getTime()){
				    	  alert(iMatrixMessage["wf.closingDateShould"]);
				    	  $('#endTime').attr("value","");
				    	  return;
				      }
			      }
			     ...
			     var cDate=new Date();
					...
					if(endDate.getTime()<currentDate.getTime()){
						alert(iMatrixMessage["wf.closingDateCurrent"]);
						$('#endTime').attr("value","");
					}
			  }
		});
